import { _decorator,director,find,randomRange, view, Component, tween, Node, Label, UITransform, Quat, input, Input,EventTouch, KeyCode, EventKeyboard, macro, Vec3, Vec2, RigidBody2D, BoxCollider2D, Contact2DType, IPhysics2DContact } from 'cc';
        ...
        this.moveActionPosition(
            ...
            .call(() => {
                ...
                this.moveActionPosition(
                    ...
                    new Vec3(
                        Math.round(randomRange(minX, maxX)),
